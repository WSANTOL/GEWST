...
import com.example.wenceslao.gestionempresa.proveedor.*;
...
public class ClienteModificarActivity extends AppCompatActivity {
    ...
    EditText editTextClienteNombre;
    EditText editTextClienteApellidos;
    EditText editTextClienteEmail;
    EditText editTextClienteTelefono;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextClienteNombre.setText(cliente.getNombre());
        editTextClienteApellidos.setText(cliente.getApellidos());
        ...
        //leer la imagen
        try {
            Utilidades.loadImageFromStorage(this,"img_cliente"+clienteId+".jpg",imageViewCliente);
    ...
    void attemptGuardar(){
        ...
        Cliente cliente=new Cliente(clienteId,nombre,apellidos,email,telefono,foto);
        ClienteProveedor.update(getContentResolver(),cliente,this);
        finish();
